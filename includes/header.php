    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" > <!-- class="navbar navbar-inverse navbar-fixed-top" -->
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><span><img src="../public/images/projector.png" style="width:25px; margin-right:10px; padding-bottom:5px">Movie Club</span></a>
        </div>
          ...
          <ul class="nav navbar-nav">
            ...
            <li <?php if($active_parent_page == "movies"){echo "class='active'";} ?>>
              ...
              <ul class='dropdown-menu'>
                <li <?php if($active_page == "view_movies"){echo "class='active'";} ?>><a href="movies.php">View Movies</a>
